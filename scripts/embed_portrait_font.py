...
-- so unlike the stat graphics it isn't regenerated on a schedule. Run this
after ever rebuilding it.

Why it matters: the character grid bakes in an advance width of exactly
0.600 em (CHAR_W 7.74 at font-size 12.9). JetBrains Mono is 600/1000 units, so
the geometry is unchanged, but a viewer whose default monospace is narrower --
